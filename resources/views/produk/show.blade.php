...
<body>
    ...
    <main>
        ...
        <form action="/produk/{{ $produk->id }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <input type="hidden"  value="{{ $produk->nama }}>
            <label for="name">Name:</label>
            <input value="{{ $produk->nama }}" type="text" id="name" name="nama" required>

            <label for="email">harga:</label>
            <input value="{{ $produk->harga }}" type="text" id="harga" name="harga" required>

            <label for="email">Stok:</label>
            <input value="{{ $produk->stok }}" type="text" id="stok" name="stok" required>

            <label for="email">Deskripsi:</label>
            <input value="{{ $produk->deskripsi }}" type="text" id="stok" name="deskripsi" required>
